...
$this->title = 'Import result for Payroll Results ';
$this->params['breadcrumbs'][] = ['label' => 'Payroll result', 'url' => ['index']];
...
<div class="box box-danger berita-acara-import-result-view">
    <div class="box-body">
        <div class="box-header with-border">
            <?= Html::a('<i class="fa fa-address-card"></i>&nbsp;&nbsp;&nbsp;Realization', ['payroll-result/index'], ['class' => 'btn btn-info']) ?>
        </div>
