...
<div class="content-responsive">
    <div class="row">
                                    ...
                                    <td>
                                        ...
                                        <?php if ($item['category_name'] == 'Take Home Pay') { ?>
                                            ...
                                            <table class="table-total-description">
                                                ...
                                                <tr>
                                                    <td class="card-data-row-text card-total" style="padding-top: 5px;">
                                                        TOTAL
                                                    </td>
        ...
        <div class="col-md-12">
            <h5>Disclosure : <br/>
                Jika Seluruh informasi ini berbeda dengan ketentuan, maka gunakan ketentuan terbaru sebagai acuan.</h5>
        </div>
        <!-- /.row -->
...
<script>
    ...
    $url = base_uri+'/hcmcollaboration/reward/web/index.php?r=site/options';
	//test
	//end test
