    ...
    <div class="box box-default color-palette-box">
        <div class="box-header with-border">
            <div class="col-lg-4">
                ...
                <input type="hidden" value="<?= $currentYear ?>" disabled class="form-control">
            </div>

            <?php if (!empty($list)) { ?>
                <div class="col-lg-4">
                    <h4>Simulation (Original Budget)</h4>
                    <?php if (!empty($list)) { ?>
                    ...
                    'options' => [
                        ...
                        'series' =>
                            ...
                            [
                                ...
                                ['name' => 'Original Budget', 'data' => []],
                                ['name' => 'Alternatif', 'data' => []],
...
$urlData = Url::to(['monitoring/get-data-tabel']);
