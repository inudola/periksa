                    ...
                    'options' => [
                        ...
                        'series' =>
                            [
                                ...
                                ['name' => 'Alternatif', 'data' => $data['alternatif']],
                            ]
                    ],
                ]);
            ...
            <div class="box-footer">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="description-block border-right">
                            <?php if(!empty($mode)) { ?>
                            <h5 class="description-header">Rp <?= Yii::$app->formatter->asDecimal($sumAlternatif, 2) ?></h5>
                            <?php } else { ?>
                                <h5 class="description-header">0</h5>
                            <?php } ?>
                            <span class="description-text">TOTAL ALTERNATIF</span><br>
                            <?= date("d-M-Y", strtotime($query->simulation->start_date)) . ' s/d ' . date("d-M-Y", strtotime($query->simulation->end_date)); ?>
                        </div>
                        <!-- /.description-block -->
                    </div>
