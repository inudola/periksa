...
<section class="content">
    <div class="content-responsive">
        <div class="row row-custom">
                        ...
                        <div class="row-custom-header row col-sm-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td colspan="3">
                                                        <h4 class="col-sm-12 table-person-name">
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td class="employee-title-dept">
                                                        <?= substr($people->title, 0, 35); ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-sm-3 text-muted nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td class="employee-title-dept">
                                                        <?= TanggalIndo($people->tanggal_masuk) ?>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <div class="col-sm-5">
                                <table style="width:100%; margin-top: 10px;">
                                    <tr>
                                        <td>
                                            <h5 class="card-title">Take Home Pay</h5></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width:100%;height:110px !important;" class="table-description">

                                                <tr>
                                                    <td class="card-data-row-text table-val-pop-description" onclick="return moreinfoModal(this);" id="37" data-toggle="modal" data-target="#moreinfo-modal-37" href="javascript:void(0);">
                                                        Gaji Dasar
                                                    </td>
                                ...
                                <table class="table-total-description">
                                    ...
                                    <tr>
                                        ...
                                        <td class="card-total money-content">
                                            <?= $formatter->asDecimal(Html::encode($basedataFull), 0); ?>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            <div class="tag-title-reward">
                <p>Reward Information</p>
            </div>
            <!--SEARCH RESULT-->
                        ...
                        <div class="box box-custom box-widget box-custom">
                            <div class="box-body" style="margin-right: 10px">
                                ...
                                <table class="card-data-table">
                                    <tr>
                                        <td colspan="2">
                                            <h5 class="card-title"><?= $item['category_name'] ?></h5></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <h6 class="text-muted card-subtitle"><?= $item['title'] ?></h6>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="vertical-align:top; width:100px;"><img
                                                    ...
                                                    src="<?= Yii::getAlias('@web') . '/' . $item['icon'] ?>" alt="icon"
                                        ...
                                        <td>
                                                    ...
                                                    foreach ($row as $x) { ?>
                                                        ...
                                                        <tr>
                                                            <td class="card-data-row-text table-val-pop-description"
                                                                ...
                                                                id="<?= $x['mst_reward_id']; ?>" data-toggle="modal"
                                                            ...
                                                            <td class="money-content" id="money-data">
                                                                ...
                                                                } else if ($item['category_name'] == 'Basic Income') {
                                                                    if ($r == 'Gaji Dasar') {
                                            ...
                                            <?php if ($item['category_name'] == 'Basic Income') { ?>
                                                <hr style="margin-top: 5px; margin-bottom: 5px;border-top: 2px solid #ececec;">
                                                <table class="table-total-description">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="card-data-row-text" style="text-align: right">
                                                        <button class="btn btn-sm col-sm-2 card-bt-detail pull-right"
                                                                onclick="return moreinfoModal(this);" id="<?= $rows; ?>"
                                                                data-toggle="modal"
                ...
                <?php foreach ($value
                    ...
                    foreach ($row as $x) { ?>
                        <div class="modal fade" id="moreinfo-modal-<?= $x['mst_reward_id']; ?>" tabindex="-1"
                             role="dialog" aria-labelledby="<?= $r ?>" aria-hidden="true">
                            ...
                            <?php if ($item['category_name'] == 'Basic Income') { ?>
                                <tr>
                                    ...
                                    <td class="col-sm-4 table-total-val table-detail-val-number">
                                        ...
                                        <?= $formatter->asDecimal(Html::encode($people->salary + $people->tunjangan + $people->tunjangan_jabatan + $people->tunjangan_rekomposisi), 0) ?>
                                    </td>
                                    <td class="col-sm-4 table-total-val table-detail-val-number">
                                        <span class='pull-left'>Rp. </span>
                                        <?= $formatter->asDecimal(Html::encode(($people->salary * 12) + ($people->tunjangan * 12) + ($people->tunjangan_jabatan * 12) + ($people->tunjangan_rekomposisi * 12)), 0) ?>
                                    </td>
                                </tr>
                            <?php } ?>
